...
// PERSISTENCE (Specific to Dictators)
let lifetimeScore = parseInt(localStorage.getItem('dictatorsScore')) || 0;
let completedLessons = JSON.parse(localStorage.getItem('completedDictatorsLessons')) || [];
...
// STATIONS 
const stations = [
    {file:"01_AdolfHitler.mp3", title:"Adolf Hitler"},
    {file:"02_AugustoPinochet.mp3", title:"Augusto Pinochet"},
    {file:"03_BenitoMussolini.mp3", title:"Benito Mussolini"},
    {file:"04_FerdinandMarcos.mp3", title:"Ferdinand Marcos"},
    {file:"05_FidelCastro.mp3", title:"Fidel Castro"},
    {file:"06_FranciscoFranco.mp3", title:"Francisco Franco"},
    {file:"07_FrancoisDuvalier.mp3", title:"François Duvalier"},
    {file:"08_HafezAndBasharAlAssad.mp3", title:"Hafez & Bashar al-Assad"},
    {file:"09_IdiAmin.mp3", title:"Idi Amin"},
    {file:"10_JosephStalin.mp3", title:"Joseph Stalin"},
    {file:"11_KimJongIlAndUn.mp3", title:"Kim Jong-il & Kim Jong-un"},
    {file:"12_MaoZedong.mp3", title:"Mao Zedong"},
    {file:"13_MengistuHaileMariam.mp3", title:"Mengistu Haile Mariam"},
    {file:"14_MobutuSeseSeko.mp3", title:"Mobutu Sese Seko"},
    {file:"15_MuammarGaddafi.mp3", title:"Muammar Gaddafi"},
    {file:"16_NicolaeCeausescu.mp3", title:"Nicolae Ceaușescu"},
    {file:"17_PolPot.mp3", title:"Pol Pot"},
    {file:"18_RobertMugabe.mp3", title:"Robert Mugabe"},
    {file:"19_SaddamHussein.mp3", title:"Saddam Hussein"},
    {file:"20_SlobodanMilosevic.mp3", title:"Slobodan Milošević"},
    {file:"21_Suharto.mp3", title:"Suharto"}
];
...
function finishQuiz() {
    lifetimeScore += totalScore; localStorage.setItem('dictatorsScore', lifetimeScore);
    const fn = audio.src.split('/').pop();
    if(!completedLessons.includes(fn)) {
        completedLessons.push(fn); localStorage.setItem('completedDictatorsLessons', JSON.stringify(completedLessons));
    }
